...
import './LpNewVersion2.css';

const CLARITY_TAG_ID = 'ttupejo85l';
const VTURB_PLAYER_ID = 'vid-69990efb80d622f3ef42b63b';
const VTURB_PLAYER_SRC =
  'https://scripts.converteai.net/e97af4fb-6abc-4093-b851-f7ad5a193ea2/players/69990efb80d622f3ef42b63b/v4/player.js';
...
export default function LpNewVersion2() {
  useEffect(() => {
    const previousTitle = document.title;
    document.title = 'Upsell 1 - V2';
  ...
  return (
    <div className="lp-newversion2-page">
      <div className="bg-ambience" aria-hidden="true">
        <div className="blob blob-primary" />
        <div className="blob blob-secondary" />
      </div>

      <div className="alert-bar">{'N\u00E3o saia desta p\u00E1gina - confira nossa nova atualiza\u00E7\u00E3o.'}</div>

      <main className="wrap">
        <div className="eyebrow">{'Plataforma de Alta Performance'}</div>

        <h1>
          Nosso dashboard foi atualizado.
          <br />
          <span className="accent">{'Assista o v\u00EDdeo para conhecer a vers\u00E3o 2.0'}</span>

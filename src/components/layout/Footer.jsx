...
const Footer = () => {
    return (
        <footer className="bg-neutral-charcoal text-neutral-mediumGray font-sans relative mt-auto">
            <div className="h-px w-full bg-primary/50 mb-10"></div>

            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
                    <div>
                        <h3 className="text-white text-xl font-bold mb-4 font-display">Afiliado Dash</h3>
                    ...
                    <div>
                        <h4 className="text-white text-base font-semibold mb-5">Suporte</h4>
                    ...
                    <div>
                        <h4 className="text-white text-base font-semibold mb-5">Redes Sociais</h4>
                        <div className="flex gap-4">
                            <a href="https://instagram.com/afiliadodash" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white hover:opacity-80 transition-opacity">
                ...
                <div className="border-t border-white/10 py-8 text-center">
                    ...
                    <div className="text-[0.85rem] text-neutral-mediumGray mt-2">

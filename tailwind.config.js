    ...
    extend: {
      ...
      keyframes: {
        ...
        rocketShake: {
          ...
          '20%': { transform: 'rotate(-47deg) translate(-1px, -1.5px)' },
          '40%': { transform: 'rotate(-43deg) translate(1px, -0.5px)' },
          '60%': { transform: 'rotate(-46deg) translate(-0.5px, -2px)' },
          '80%': { transform: 'rotate(-44deg) translate(0.5px, -1px)' },
        },
      }
    },
  },
